...
export function PropertySwitcher() {
  const { currentProperty, properties, setProperty, loading } = useProperty()
  ...
  return (
    <DropdownMenu>
          ...
          >
            <div className="flex items-center gap-3 overflow-hidden">
              ...
              <span className="truncate">
                {loading ? 'Loading...' : (currentProperty?.name || 'Select Property')}
              </span>
            </div>
      ...
      />
      <DropdownMenuContent
        className="w-56 rounded-xl premium-card backdrop-blur-xl"
        align="start"
      >
        <DropdownMenuGroup>
